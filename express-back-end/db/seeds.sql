...
('Salma', 'Ibrahim', 'test@example.com', 'test', null);

INSERT INTO bookclubs (user_id, name, description, private, image_url, current_book)
VALUES ('1', 'Horrors Galore', 'Getting spooky all year round with heart-pounding thrillers and mind-boggling horrors!', false, 'https://i.imgur.com/GIR7eDB.jpg', 9780671751180),
('2', 'Fantasy Explorers', 'In this club we read all sort of Fantasy ranging from JRR Tolkien, Laini Taylor, Patrick Rothfuss, N.K Jemisin, etc!', true, 'https://i.imgur.com/2v9TsPF.jpg', 9780553593716),
('3', 'The Non-Fiction Cafe', 'We focus on great pieces of non-fiction including memoirs, autobiographies, and more!', false, 'https://i.imgur.com/EYeqxnZ.jpg', 9781631498916),
...
('5', 'Sci-Fi Oh My!', 'Killer robots! Dystopian worlds! What even is steampunk?! Join us to find out!', false, 'https://i.imgur.com/wdw8yU3.png', 0441013597),
('6', 'History In The Pages', 'In this book club we love to learn from our collective past and read fascinating history!', false, 'https://i.imgur.com/mCJJrl4.jpg', 9780609809648),
('7', 'Shakespearean Club', 'Welcometh to the shakepearean booketh club.  We readeth all the written works of Shakespeare himself and art very snobby about it', false, 'https://i.imgur.com/T3JsYC0.png', 0451526929),
('8', 'Up-And-Coming Authors', 'Read about works from new and exciting authors as they begin their journey crafting the written word!', true, 'https://i.imgur.com/l0OXgPw.jpg', 9780307424983),
('9', 'The Poetry Garden', 'We discuss Poetry!', false, 'https://i.imgur.com/xwFczb7.jpg', 9781466877801);
